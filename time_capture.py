...
if __name__ == '__main__':
    try:
        ...
        video_stream_widget = VideoScreenshot(rtsp_stream_links, video_stream_widget.camera_names, video_stream_widget.screenshot_interval, video_stream_widget.disk_limit, video_stream_widget.duration_minutes)
